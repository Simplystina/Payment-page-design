               ...
               <form onSubmit={formik.handleSubmit}>
                                ...
                                <Stack w="full" spacing="8">
                                    <VStack align="baseline">
                                        <Text fontWeight="700" fontSize="14px" color="#000000">Name</Text>
                                        <Input 
                                        name="name" 
                                        id="name" 
                                    ...
                                    <VStack align="baseline">
                                        <Text fontWeight="700" fontSize="14px" color="#000000">Email Address <span style={{color: "red"}}>*</span></Text>
                                    ...
                                    <VStack align="baseline">
                                        <Text fontWeight="700" fontSize="14px" color="#000000">Address 1</Text>
                                        <Input 
                                    ...
                                    <VStack align="baseline">
                                        <Text fontWeight="700" fontSize="14px" color="#000000">Address 2</Text>
                                        <Input name="address2" 
                                    ...
                                    <Flex w="100%" justifyContent="space-between">
                                        <VStack align="baseline" w="60%">
                                            <Text fontWeight="700" fontSize="14px" color="#000000">Local Government</Text>
                                            <Input name="city" 
                                            id="city" 
                                        ...
                                        <VStack align="baseline" w="30%">
                                            <Text fontWeight="700" fontSize="14px" color="#000000">State</Text>
